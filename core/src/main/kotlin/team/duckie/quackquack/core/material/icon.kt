...
public value class QuackIcon(@DrawableRes public val drawableId: Int) {
    public companion object {
        ...
        internal val BottomNavHome: QuackIcon = QuackIcon(R.drawable.quack_ic_home_bottom_nav_24)

        internal val BottomNavHomeSelected: QuackIcon = QuackIcon(R.drawable.quack_ic_home_bottom_nav_selected_24)

        internal val BottomNavSearch: QuackIcon = QuackIcon(R.drawable.quack_ic_search_bottom_nav_24)

        internal val BottomNavSearchSelected: QuackIcon = QuackIcon(R.drawable.quack_ic_search_bottom_nav_selected_24)

        internal val BottomNavNotice: QuackIcon = QuackIcon(R.drawable.quack_ic_notice_bottom_nav_24)

        internal val BottomNavNoticeSelected: QuackIcon = QuackIcon(R.drawable.quack_ic_notice_bottom_nav_selected_24)

        internal val BottomNavMessage: QuackIcon = QuackIcon(R.drawable.quack_ic_message_bottom_nav_24)

        internal val BottomNavMessageSelected: QuackIcon = QuackIcon(R.drawable.quack_ic_message_bottom_nav_selected_24)
    }
}
