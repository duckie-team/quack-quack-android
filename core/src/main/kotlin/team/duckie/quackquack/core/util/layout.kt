 ...
 *
 * 각각 주어진 사이즈로 min과 max를 모두 설정하는 [Constraints]의
 * 유틸 함수 입니다. 만약 인자로 주어진 값이 null 이라면
 * min과 max에 맞는 원래의 값을 그대로 사용합니다.
 *
...
/**
 * 주어진 [Placeable]에서 width 값을 가져오거나,
 * 유효하지 않을 경우 0을 반환합니다.
 *
...
/**
 * 주어진 [Placeable]에서 height 값을 가져오거나,
 * 유효하지 않을 경우 0을 반환합니다.
 *
 * @receiver height 값을 가져올 [Placeable]
 */
