...
import team.duckie.quackquack.sugar.processor.Logger
import team.duckie.quackquack.sugar.processor.prependLogPrefix
...
private fun IrSimpleFunction.getSugarKDoc(referFqn: FqName, sugarTokenName: String): String {
    ...
    if (kdocDefaultSection?.getContent() == null) return ""
