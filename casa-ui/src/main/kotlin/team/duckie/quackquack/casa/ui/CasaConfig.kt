...
public data class CasaConfig(
    ...
    public val reportBugUrl: String = "https://github.com/duckie-team/quack-quack-android/issues/new?assignees=jisungbin&labels=runtime+issue&template=bug_report.md&title=",
