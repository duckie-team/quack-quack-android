...
class AideDecorateModifierDetector : Detector(), SourceCodeScanner {
    ...
    internal companion object {
        ...
        private const val IssueBrief = "사용하고자 하는 DecorateModifier가 해당 도메인에 선언된 게 맞나요?"
        private const val IssueExplanation = """
            ...
            DecorateModifier 사용이 감지됐을 때는 `$IssueId` 경고를 발생시킵니다.
        """

        internal const val IncidentMessage = "도메인에 벗어나는 DecorateModifier의 사용이 감지되었습니다."
