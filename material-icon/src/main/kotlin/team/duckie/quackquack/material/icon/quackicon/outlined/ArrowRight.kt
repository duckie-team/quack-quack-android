...
public val OutlinedGroup.ArrowRight: ImageVector
  get() {
    if (_arrowRight != null) {
      return _arrowRight!!
    }
    _arrowRight = Builder(
      ...
      path(
        ...
        moveTo(10.166f, 15.187f)
        lineTo(12.001f, 13.498f)
        lineTo(13.835f, 11.818f)
        lineTo(12.001f, 10.133f)
        lineTo(10.166f, 8.448f)
      }
    }
      .build()
    return _arrowRight!!
