...
public val ColoredGroup.Profile: ImageVector
  get() {
    if (_profile != null) {
      return _profile!!
    }
    _profile = Builder(
      ...
      path(
        ...
        strokeLineWidth = 0.5f, strokeLineCap = strokeCapRound, strokeLineJoin =
      ...
      path(
        ...
        curveTo(17.5165f, 12.2933f, 17.0745f, 12.1211f, 16.6148f, 12.1154f)
        ...
        curveTo(5.5098f, 20.3636f, 5.8336f, 20.4979f, 6.1719f, 20.502f)
