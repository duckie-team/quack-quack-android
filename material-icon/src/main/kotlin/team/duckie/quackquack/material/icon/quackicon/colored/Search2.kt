...
public val ColoredGroup.Search2: ImageVector
  get() {
    if (_search2 != null) {
      return _search2!!
    }
    _search2 = Builder(
      ...
      path(
        fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFFFF8300)),
        strokeLineWidth = 2.2f, strokeLineCap = strokeCapRound, strokeLineJoin =
        strokeJoinRound, strokeLineMiter = 4.0f, pathFillType = NonZero
      ) {
        moveTo(14.5f, 15.0f)
