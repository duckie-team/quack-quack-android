 ...
 *
 * Playground에서 [QuackAnimationMillis] 편집 후 기본값으로 되돌리고 싶을 때 기본값을 참조하기 위해
 * public으로 공개합니다.
 */
 ...
 *
 * 애니메이션 디버깅 용도로 수정을 허용합니다. Transition API를 사용해 애니메이션을 디버깅하는 방법도 있지만 컴포즈에서
 * Preview가 최적하게 돌아가지 않아 수동 애니메이션 디버깅도 고려합니다.
 *
...
public object QuackAnimationSpec {
  /**
   * 일부 환경에서는 애니메이션이 없이 진행돼야 할 때도 있습니다. 이 값을 true로 설정하면 모든 애니메이션을 무시합니다.
   *
...
/**
 * [QuackAnimationSpec.snapMode] 대신에 한 번만 선택적으로 애니메이션 여부를 결정하기 위해 사용할 수
 * 있습니다.
 *
