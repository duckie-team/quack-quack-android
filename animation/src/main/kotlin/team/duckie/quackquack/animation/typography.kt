 ...
 *
 * [TextAlign]의 생성자와 필드가 다 internal 이기에 [TextAlign]의 인자 값으로 될 수 있는 1~6 까지의
 * [Int] 값을 애니메이션하여 각각 값에 맞는 [TextAlign]을 찾아서 생성하는 식으로 구현하였습니다.
 */
 ...
 *
 * [QuackTypography.color], [QuackTypography.size],
 * [QuackTypography.weight], [QuackTypography.letterSpacing],
 * [QuackTypography.lineHeight],
 * [QuackTypography.textAlign] 에 애니메이션을 적용합니다.
 *
 * 현재 weight 애니메이션이 적용되지 않습니다. weight는 100 단위로 증가하기 때문에 100~n00으로 애니메이션되는
 * weight가 구현돼 있지 않아 생기는 이슈입니다.
 *
 ...
 *     끝났을 때 호출될 콜백
 * @param sizeAnimationFinishedListener [QuackTypography.size]의 애니메이션이 끝났을
 *     때 호출될 콜백
 * @param letterSpacingAnimationFinishedListener
 *     [QuackTypography.letterSpacing]의 애니메이션이 끝났을 때 호출될 콜백
