...
class SugarCompilerRegistrar : ComponentRegistrar {
  ...
  companion object {
    ...
    private fun CompilerConfiguration.getSugarIrExtension() =
      SugarCompilerExtension(logger = getLogger("sugar-compiler"))
  }
}
