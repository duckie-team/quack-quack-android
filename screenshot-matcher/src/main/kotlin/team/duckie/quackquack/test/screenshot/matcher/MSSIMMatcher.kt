...
/**
 * Image comparison using Structural Similarity Index, developed by Wang,
 * Bovik, Sheikh, and Simoncelli. Details can be read in their paper:
...
class MSSIMMatcher(
  ...
  /**
   * This calculates the position in an array that would represent a bitmap
  ...
  /**
   * This method will find the mean of a window in both sets of pixels. The
   * return is an array where the first double is the mean of the first set
   * and the second double is the mean of the second set.
   */
  ...
  /**
   * Finds the variance of the two sets of pixels, as well as the covariance
   * of the windows. The return value is an array of doubles, the first is
   * the variance of the first set of pixels, the second is the variance
   * of the second set of pixels, and the third is the covariance.
   */
