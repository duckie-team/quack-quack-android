...
class CoreAideGenerationTest(private val useKspIncremental: Boolean) {
    @get:Rule
    val temporaryFolder = TemporaryFolder.builder().assureDeletion().build()

    companion object {
        @JvmStatic
        @Parameterized.Parameters(name = "useKspIncremental = {0}")
        ...
        expectThat(aideComponentsKt).withNotNull {
            get(File::readText).isKtEqualTo(
                ...
                internal val aideComponents: Map<String, List<String>> = run {
                  val aide = mutableMapOf<String, List<String>>()
                  aide["button"] = listOf("QuackButton", "QuackButton2", "QuackButton4")
                  aide["text"] = listOf("QuackText", "QuackText2")
                  aide
                }
    ...
    private fun prepareCompilation(vararg sourceFiles: SourceFile): KotlinCompilation {
        return KotlinCompilation().apply {
            ...
            kspIncremental = this@CoreAideGenerationTest.useKspIncremental
